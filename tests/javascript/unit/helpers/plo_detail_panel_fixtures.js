      ...
      sections: [
        {
          ...
          feedback_comments: "Strong methodological rigor across the board.",
          _section: {
            section_number: "001",
            enrollment: 32,
            narrative_celebrations: "Students showed excellent collaboration.",
            narrative_challenges:
              "Time management was an issue for some groups.",
            narrative_changes:
              "Will add a mid-project checkpoint next semester.",
          ...
          _template: {
            assessment_method: "Lab Report Rubric",
            description: "Formulate a testable hypothesis.",
          },
        },
        {
          ...
          _section: {
            section_number: "002",
            enrollment: 24,
            narrative_celebrations: null,
            narrative_challenges:
              "Many students struggled with statistical analysis.",
            narrative_changes: null,
            reconciliation_note: null,
          },
          _term: { name: "Fall 2025" },
