...
class TestImportServiceConflictBug:
    ...
    def test_existing_course_with_identical_data_should_be_detected_as_conflict(
        ...
        assert success == True, "Should succeed when handling existing course with use_theirs"
        ...
        assert (self.import_service.stats['records_updated'] > 0 or 
                self.import_service.stats['records_skipped'] > 0)
    ...
    def test_detect_course_conflict_method_directly(self):
        ...
        with patch('import_service.get_course_by_number') as mock_get_course:
            ...
            conflicts = self.import_service.detect_course_conflict(self.import_course_data)
...
if __name__ == "__main__":
    ...
    pytest.main([__file__ + "::TestImportServiceConflictBug::test_existing_course_with_identical_data_should_be_detected_as_conflict", "-v"])
