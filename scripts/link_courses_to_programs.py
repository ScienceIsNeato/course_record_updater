...
def main():
    ...
    institution_id = institution.get("id") if isinstance(institution, dict) else institution.id
    institution_name = institution.get("name") if isinstance(institution, dict) else institution.name
