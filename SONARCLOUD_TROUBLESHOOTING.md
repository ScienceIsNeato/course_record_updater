...
2. Verify it matches `scienmockusneato` (lowercase)
...
sonar-scanner -Dsonar.projectKey=ScienceIsNeato_course_record_updater \
              -Dsonar.organization=scienmockusneato \
...
- Should be `scienmockusneato` (lowercase)
