...
# ============================================================================
# CLO WORKFLOW ENDPOINTS (Submission & Approval)
# ============================================================================


@api.route("/outcomes/<outcome_id>/submit", methods=["POST"])
@permission_required("submit_clo")
def submit_clo_for_approval_endpoint(outcome_id: str):
    """
...
@api.route("/outcomes/audit", methods=["GET"])
@permission_required("audit_clo")
def get_clos_for_audit_endpoint():
    """
...
@api.route("/outcomes/<outcome_id>/approve", methods=["POST"])
@permission_required("audit_clo")
def approve_clo_endpoint(outcome_id: str):
    """
...
@api.route("/outcomes/<outcome_id>/request-rework", methods=["POST"])
@permission_required("audit_clo")
def request_clo_rework_endpoint(outcome_id: str):
    """
...
@permission_required("audit_clo")
def get_clo_audit_details_endpoint(outcome_id: str):
    """
    ...
    try:
        ...
        return handle_api_error(
            e, "Get CLO audit details", "Failed to retrieve CLO audit details"
        )
