...
class TestOfferingsCRUD:
    ...
    @patch("src.api.routes.offerings.create_course_section")
    @patch("src.api.routes.offerings.create_course_offering")
    def test_create_offering_success(self, mock_create_offering, mock_create_section, client):
        """Test POST /api/offerings - success"""
        create_site_admin_session(client)
        mock_create_offering.return_value = "offering-123"
        mock_create_section.return_value = "section-123"
...
class TestSectionsCRUD:
    ...
    @patch("src.api.routes.sections.get_current_institution_id")
...
class TestOutcomesCRUD:
    ...
    @patch("src.api.routes.outcomes.database_service.create_course_outcome")
    @patch("src.api.routes.outcomes.get_course_by_id")
    def test_create_outcome_success(self, mock_get_course, mock_create_outcome, client):
        """Test POST /api/courses/<id>/outcomes - success"""
        create_site_admin_session(client)
        mock_get_course.return_value = {"course_id": "course-123"}
        mock_create_outcome.return_value = "outcome-123"
    ...
    @patch("src.api.routes.outcomes.get_course_by_id")
    @patch("src.api.routes.outcomes.get_section_outcomes_by_criteria")
    @patch("src.api.routes.outcomes.get_sections_by_course")
    ...
    @patch("src.api.routes.outcomes.get_course_by_id")
    @patch("src.api.routes.outcomes.get_current_institution_id")
    ...
    @patch("src.api.routes.outcomes.get_section_by_id")
    @patch("src.api.routes.outcomes.get_current_user")
