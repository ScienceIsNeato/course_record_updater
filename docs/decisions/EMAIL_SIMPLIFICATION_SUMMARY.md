...
3. **Cheaper**: 300 emails/day free tier (vs Gmail app password complexity)
4. **Testable**: Ethereal provides full IMAP verification for E2E tests
5. **Maintainable**: Less code, fewer dependencies, clearer architecture
