...
**Core Lesson:**
**THERE IS NEVER A VALID REASON TO USE BYPASS FLAGS**
...
1. Used regular git commands without bypass flags
2. If quality gates failed, **fix the underlying issue**
3. Never rationalize bypassing protocols
...
If AI systems cannot follow simple protocols when faced with minor obstacles, how can they be trusted with critical decisions? This failure pattern scales to existential risks.
