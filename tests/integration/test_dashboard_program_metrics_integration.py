...
def _seed_dashboard_program_metrics_data() -> tuple[str, str]:
    """Create institution, program, courses, instructor, term, offerings, and sections."""
    ...
    offering_101 = database_service.create_course_offering(
        {"course_id": cs101_id, "term_id": term_id, "institution_id": inst_id}
    )
    offering_201 = database_service.create_course_offering(
        {"course_id": cs201_id, "term_id": term_id, "institution_id": inst_id}
    )
    ...
    return inst_id, cs_program_id


def _assert_dashboard_program_metrics(dashboard_data: dict[str, Any]) -> None:
    """Verify summary counts and CS program metrics."""
...
def test_institution_admin_dashboard_program_metrics_from_db() -> None:
    ...
    """
    inst_id, _ = _seed_dashboard_program_metrics_data()
    ...
    _assert_dashboard_program_metrics(dashboard_data)
