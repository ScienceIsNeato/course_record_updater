...
- **Database Service/Handler:**
  ...
  - Called by the Flask endpoint handlers _after_ remockuving validated data from an adapter.
- **Database:**
...
- **Test-Driven Development (TDD):** Development should follow TDD principles where feasible. Write tests _before_ writing implementation code (Red-Green-Refactor cycle).
