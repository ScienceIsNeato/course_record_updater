...
Provides REST API endpoints for course CRUD operations:
- GET /courses - List courses with filtering
- POST /courses - Create a new course
- GET /courses/<course_number> - Get course by number
- GET /courses/by-id/<course_id> - Get course by ID
- GET /courses/unassigned - List unassigned courses
- PUT /courses/<course_id> - Update course
- DELETE /courses/<course_id> - Delete course
- POST /courses/<course_id>/assign-default - Assign to default program
- POST /courses/<course_id>/duplicate - Duplicate course
- GET /courses/<course_id>/programs - Get programs for course
"""
...
def _get_current_user_safe() -> Dict[str, Any]:
    """Get current user and ensure it is not None (for type safety)."""
...
@courses_bp.route("/courses/<course_id>/programs", methods=["GET"])
@permission_required("view_program_data")
