...
class TestCoursesListRoute:
    ...
    def test_courses_list_requires_authentication(self, client: Any) -> None:
    ...
    def test_courses_list_renders_for_authenticated_user(
...
class TestUsersListRoute:
    ...
    def test_users_list_requires_authentication(self, client: Any) -> None:
        """Unauthenticated users should be redirected to login"""
    ...
    def test_users_list_renders_for_authenticated_user(
        self, authenticated_client: Any
    ) -> None:
...
class TestSectionsListRoute:
    ...
    def test_sections_list_requires_authentication(self, client: Any) -> None:
        """Unauthenticated users should be redirected to login"""
    ...
    def test_sections_list_renders_for_authenticated_user(
        self, authenticated_client: Any
    ) -> None:
