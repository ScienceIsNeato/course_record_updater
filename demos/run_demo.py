...
class DemoRunner:
    ...
    def show_manual_steps(self, action: str, automated: Dict, human_text: str):
        ...
        if action == 'api_post' and '/auth/login' in automated.get('endpoint', ''):
            ...
            print("  1. Navigate to http://localhost:3001/login")
            ...
            print("  1. Navigate to Courses page")
            print("  2. Find BIOL-101 in table")
            print("  3. Click Duplicate button (copy icon)")
            print(f"  4. Change course number to: {new_number}")
            print("  5. Select programs in dropdown")
            print("  6. Click 'Duplicate' button")
        elif action == 'api_put' and '/sections/' in automated.get('endpoint', ''):
            data = automated.get('data', {})
            print("  1. Navigate to Assessments page")
            print("  2. Select course from dropdown")  # nosec B608
            ...
            print("  6. Click 'Save Course Data'")
        elif action == 'run_command':
            cmd = automated.get('command', '')
            print("  This is a background script, no manual UI equivalent")
            print(f"  Script: {cmd}")
        elif human_text:
            ...
            print("  [No manual steps needed - navigation only]")
        print()
