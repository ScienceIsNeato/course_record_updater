...
class TestGetMimetypeForExtension:
    ...
    def test_xlsx_mimetype(self) -> None:
        """Test XLSX mimetype."""
...
class TestResolveInstitutionScope:
    ...
    def test_resolve_with_institution_context(
        self, mock_get_inst_id: Any, mock_get_user: Any
    ) -> None:
    ...
    def test_resolve_as_site_admin_without_context(
        self, mock_get_all_inst: Any, mock_get_inst_id: Any, mock_get_user: Any
    ) -> None:
...
class TestHandleApiError:
    ...
    def test_handle_api_error_returns_json_response(self, app: Any) -> None:
    ...
    def test_handle_api_error_custom_status_code(self, app: Any) -> None:
    ...
    def test_handle_api_error_default_message(self, app: Any) -> None:
...
class TestValidateRequestJson:
    ...
    def test_validate_json_success(self, app: Any) -> None:
    ...
    def test_validate_json_with_required_fields_success(self, app: Any) -> None:
    ...
    def test_validate_json_missing_data(self, app: Any) -> None:
    ...
    def test_validate_json_missing_required_field(self, app: Any) -> None:
    ...
    def test_validate_json_multiple_missing_required_fields(self, app: Any) -> None:
    ...
    def test_validate_json_empty_field_value(self, app: Any) -> None:
