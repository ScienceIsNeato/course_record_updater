...
def test_tc_crud_inst_001_update_own_profile(
    ...
    instructor_page.wait_for_selector("#editUserModal", state="hidden", timeout=30000)
...
def test_tc_crud_inst_002_cannot_delete_users(
    ...
    # Login as instructor
    instructor_page = login_as_user(page, BASE_URL, instructor_email, GENERIC_PASSWORD)
