...
class TestValidateCeiTermName:
    ...
    def test_validate_cei_term_standard_format(self) -> None:
    ...
    def test_validate_cei_term_abbreviated_format(self) -> None:
    ...
    def test_validate_cei_term_invalid_formats(self) -> None:
...
class TestParseCeiTerm:
    ...
    def test_parse_cei_term_valid_formats(self) -> None:
    ...
    def test_parse_cei_term_invalid_length(self) -> None:
...
class TestHelperFunctions:
    ...
    def test_extract_department_from_course(self) -> None:
...
class TestParseCeiExcelRow:
    ...
    def test_parse_cei_excel_row_complete_data(self) -> None:
    ...
    def test_parse_cei_excel_row_with_email_format(self) -> None:
    ...
    def test_parse_cei_excel_row_minimal_data(self) -> None:
    ...
    def test_parse_cei_excel_row_exception_handling(self) -> None:
...
class TestCEIExcelAdapterErrorHandling:
    ...
    def test_validate_basic_file_properties_file_not_found(self) -> None:
    ...
    def test_read_excel_sample_exception(self) -> None:
    ...
    def test_validate_course_column_no_valid_courses(self) -> None:
    ...
    def test_validate_term_column_no_valid_terms(self) -> None:
    ...
    def test_validate_student_count_column_invalid_data(self) -> None:
    ...
    def test_validate_student_count_column_no_valid_numbers_string(self) -> None:
    ...
    def test_check_format_compatibility_hybrid(self) -> None:
    ...
    def test_validate_data_patterns_term_error(self) -> None:
    ...
    def test_validate_student_count_column_no_column(self) -> None:
    ...
    def test_validate_student_count_column_has_error(self) -> None:
    ...
    def test_validate_course_column_no_column(self) -> None:
    ...
    def test_validate_term_column_no_column(self) -> None:
    ...
    def test_parse_file_excel_read_error(self) -> None:
    ...
    def test_parse_file_empty_excel(self) -> None:
    ...
    def test_validate_data_patterns_with_student_error(self) -> None:
    ...
    def test_read_file_excel_read_failure(self) -> None:
...
class TestExtractCloData:
    ...
    def test_extract_clo_empty_text(self) -> None:
    ...
    def test_extract_clo_no_colon(self) -> None:
    ...
    def test_extract_clo_no_dot_in_code(self) -> None:
    ...
    def test_extract_clo_course_mismatch(self) -> None:
    ...
    def test_extract_clo_valid_format(self) -> None:
    ...
    def test_extract_clo_exception_handling(self) -> None:
