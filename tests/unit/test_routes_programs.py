...
def _response_tuple(result: Any) -> tuple[Response, int]:
    assert isinstance(result, tuple)
    response, status = result
    return cast(Response, response), cast(int, status)


class TestRemoveCourseHelpers:
    """Test helper functions for remove_course_from_program_api."""

    def test_validate_program_for_removal_success(self) -> None:
    ...
    def test_validate_program_for_removal_not_found(self) -> None:
    ...
    def test_get_default_program_id_with_default(self) -> None:
    ...
    def test_get_default_program_id_no_default(self) -> None:
    ...
    def test_get_default_program_id_no_institution(self) -> None:
    ...
    def test_get_default_program_id_no_programs(self) -> None:
    ...
    def test_remove_course_with_orphan_handling_success(self) -> None:
    ...
    def test_remove_course_with_orphan_handling_no_default_program(self) -> None:
    ...
    def test_build_removal_response_success(self) -> None:
    ...
    def test_build_removal_response_failure(self) -> None:
        ...
        with app.app_context():
            mock_program = {"name": "Test Program"}
            response, status = _response_tuple(
                _build_removal_response(False, "course1", mock_program)
            )
...
class TestBulkManageHelpers:
    ...
    def test_validate_bulk_manage_request_success(self) -> None:
    ...
    def test_validate_bulk_manage_request_no_data(self) -> None:
        ...
        with app.test_client() as client:
            ...
            with client.application.test_request_context(json={}):
                response, status = _response_tuple(_validate_bulk_manage_request())
                data = response.get_json()
                assert data["success"] is False
                assert "No data provided" in data["error"]
                assert status == 400

    def test_validate_bulk_manage_request_invalid_action(self) -> None:
    ...
    def test_validate_bulk_manage_request_missing_course_ids(self) -> None:
    ...
    def test_execute_bulk_add(self) -> None:
    ...
    def test_execute_bulk_remove_with_default_program(self) -> None:
    ...
    def test_execute_bulk_remove_no_default_program(self) -> None:
