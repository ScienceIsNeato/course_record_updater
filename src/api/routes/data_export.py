...
Provides endpoints for exporting data to Excel/CSV formats.
"""
...
# Create blueprint
data_export_bp = Blueprint("data_export", __name__, url_prefix="/api")
...
@data_export_bp.route("/export/data", methods=["GET"])
@login_required
