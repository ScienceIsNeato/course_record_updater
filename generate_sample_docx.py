...
business_data = [
    {
        ...
        "term": "FA2024",
        "num_students": "30",
        "grades_str": "A=5, B=15, C=8, D=1, F=1",
    },
    {
        ...
        "term": "FA2024",
        "num_students": "25",
        "grades_str": "A=4, B=10, C=6, D=3, F=2",
    },
    {
    ...
    },
    {
        ...
        "term": "SP2025",
        "num_students": "28",
        "grades_str": "A=7, B=12, C=5, D=4, F=0",
    },
    {
        ...
        "term": "FA2024",
        "num_students": "40",
        "grades_str": "A=8, B=18, C=10, D=3, F=1",
    },
]
...
def create_business_docx(filename="business_sample.docx"):
    ...
    for i, course in enumerate(business_data):
        document.add_paragraph(
            "COURSE DATA", style="Heading 2"
        )  # Use a style for visual separation
