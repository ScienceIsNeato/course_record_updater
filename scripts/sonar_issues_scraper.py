...
class SonarCloudScraper:
    ...
    def get_issues(self, severities: List[str] = None, types: List[str] = None, limit: int = 50) -> List[Dict]:
...
def main():
    parser = argparse.ArgumentParser(description="Scrape SonarCloud issues for actionable feedback")
    parser.add_argument("--project-key", default="course-record-updater", 
