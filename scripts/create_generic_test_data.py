...
from tests.test_constants import (
    ...
    TEST_INSTRUCTOR_1,
    TEST_INSTRUCTOR_2,
    TEST_OFFERING_CS101_FA2024,
    TEST_OFFERING_CS202_FA2024,
    TEST_OFFERING_ENG301_SP2025,
    TEST_OFFERING_MATH201_FA2024,
    TEST_OFFERING_MATH401_SP2025,
    TEST_OUTCOME_1,
    TEST_OUTCOME_2,
    TEST_OUTCOME_3,
    TEST_OUTCOME_4,
...
with zipfile.ZipFile(OUTPUT_FILE, "w", zipfile.ZIP_DEFLATED) as zf:
    ...
    terms_csv = [
        ...
        [
            TEST_TERM_FA2024.id,
            TEST_TERM_FA2024.name,
            TEST_TERM_FA2024.display_name,
            TEST_TERM_FA2024.start_date,
            TEST_TERM_FA2024.end_date,
            TEST_TERM_FA2024.due_date,
            str(TEST_TERM_FA2024.active).lower(),
            TEST_INSTITUTION.id,
            CREATED_AT,
            UPDATED_AT,
        ],
        [
            TEST_TERM_SP2025.id,
            TEST_TERM_SP2025.name,
            TEST_TERM_SP2025.display_name,
            TEST_TERM_SP2025.start_date,
            TEST_TERM_SP2025.end_date,
            TEST_TERM_SP2025.due_date,
            str(TEST_TERM_SP2025.active).lower(),
            TEST_INSTITUTION.id,
            CREATED_AT,
            UPDATED_AT,
        ],
        ...
        [
            TEST_TERM_SU2023.id,
            TEST_TERM_SU2023.name,
            TEST_TERM_SU2023.display_name,
            TEST_TERM_SU2023.start_date,
            TEST_TERM_SU2023.end_date,
            TEST_TERM_SU2023.due_date,
            str(TEST_TERM_SU2023.active).lower(),
            TEST_INSTITUTION.id,
            CREATED_AT,
            UPDATED_AT,
        ],
    ...
    course_offerings_csv = [
        ...
        [
            TEST_OFFERING_CS101_FA2024.id,
            TEST_OFFERING_CS101_FA2024.course_id,
            TEST_OFFERING_CS101_FA2024.term_id,
            TEST_INSTITUTION.id,
            TEST_OFFERING_CS101_FA2024.status,
            TEST_OFFERING_CS101_FA2024.capacity,
            TEST_OFFERING_CS101_FA2024.enrollment,
            TEST_OFFERING_CS101_FA2024.section_count,
            CREATED_AT,
            UPDATED_AT,
        ],
        [
            TEST_OFFERING_MATH201_FA2024.id,
            TEST_OFFERING_MATH201_FA2024.course_id,
            TEST_OFFERING_MATH201_FA2024.term_id,
            TEST_INSTITUTION.id,
            TEST_OFFERING_MATH201_FA2024.status,
            TEST_OFFERING_MATH201_FA2024.capacity,
            TEST_OFFERING_MATH201_FA2024.enrollment,
            TEST_OFFERING_MATH201_FA2024.section_count,
            CREATED_AT,
            UPDATED_AT,
        ],
        [
            TEST_OFFERING_ENG301_SP2025.id,
            TEST_OFFERING_ENG301_SP2025.course_id,
            TEST_OFFERING_ENG301_SP2025.term_id,
            TEST_INSTITUTION.id,
            TEST_OFFERING_ENG301_SP2025.status,
            TEST_OFFERING_ENG301_SP2025.capacity,
            TEST_OFFERING_ENG301_SP2025.enrollment,
            TEST_OFFERING_ENG301_SP2025.section_count,
            CREATED_AT,
            UPDATED_AT,
        ],
        # Full capacity (edge case)
        [
            TEST_OFFERING_CS202_FA2024.id,
            TEST_OFFERING_CS202_FA2024.course_id,
            TEST_OFFERING_CS202_FA2024.term_id,
            TEST_INSTITUTION.id,
            TEST_OFFERING_CS202_FA2024.status,
            TEST_OFFERING_CS202_FA2024.capacity,
            TEST_OFFERING_CS202_FA2024.enrollment,
            TEST_OFFERING_CS202_FA2024.section_count,
            CREATED_AT,
            UPDATED_AT,
        ],
        # Zero enrollment (edge case)
        [
            TEST_OFFERING_MATH401_SP2025.id,
            TEST_OFFERING_MATH401_SP2025.course_id,
            TEST_OFFERING_MATH401_SP2025.term_id,
            TEST_INSTITUTION.id,
            TEST_OFFERING_MATH401_SP2025.status,
            TEST_OFFERING_MATH401_SP2025.capacity,
            TEST_OFFERING_MATH401_SP2025.enrollment,
            TEST_OFFERING_MATH401_SP2025.section_count,
            CREATED_AT,
            UPDATED_AT,
        ],
    ]
